...
@app.get("/api/architecture/cost-analysis")
def get_cost_analysis():
    """
    Get detailed cost analysis for the synthesized architecture.
    
    Returns cost breakdowns by layer, category, region, cost drivers,
    ...
    try:
        ...
        from architecture_synthesis.analysis import CostAnalyzer
        
        analyzer = CostAnalyzer()
        analysis = analyzer.analyze_costs(
            latest_synthesized_architecture["resolved_architecture"]["graph"],
            latest_synthesized_architecture
        )
